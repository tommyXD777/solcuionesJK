...
<body>
    <header class="bg-dark text-white text-center py-4">
        <div class="container">
            ...
            <nav class="d-flex justify-content-center gap-3 flex-wrap mt-3">
                <?php if (isset($_SESSION['usuario'])): ?>
                    <a href="/mvc/perfil.php" class="btn btn-outline-light">Mi Perfil</a>
                    <a href="/carrito/carrito.php" class="btn btn-outline-light">Carrito 🛒</a>
